...
#ifndef FOLDER_SWIFT_H
#define FOLDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Folder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Folder18MediaUploadSession")
@interface MediaUploadSession : NSObject
...
@class NSData;
@interface MediaUploadSession (SWIFT_EXTENSION(Folder)) <NSURLSessionDataDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session dataTask:(NSURLSessionDataTask * _Nonnull)dataTask didReceiveData:(NSData * _Nonnull)data;
@end

@class NSURLSessionTask;
@interface MediaUploadSession (SWIFT_EXTENSION(Folder)) <NSURLSessionTaskDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session task:(NSURLSessionTask * _Nonnull)task didCompleteWithError:(NSError * _Nullable)error;
- (void)URLSessionDidFinishEventsForBackgroundURLSession:(NSURLSession * _Nonnull)session;
@end

SWIFT_CLASS("_TtC6Folder20WordPressAuthManager")
@interface WordPressAuthManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASWebAuthenticationSession;
@interface WordPressAuthManager (SWIFT_EXTENSION(Folder)) <ASWebAuthenticationPresentationContextProviding>
